...
# ggplot(dfc, aes(x = "", y = freq, fill = class)) +
...
ggplot(dfc[1:10, ], aes("", freq, fill = class)) +
...
ggplot(dfc, aes(x = reorder(term, freq), y = freq)) +
...
# Plot keywords by implementation languages
